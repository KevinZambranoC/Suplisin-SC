            ...
            <div className="text-center ltr:sm:text-left rtl:sm:text-right">
                ...
                <div className="p-4 mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4 ">
                    <div className="block bg-white/[.85] rounded-lg shadow-xl text-center">
                        <img alt="drywall" src="https://i.ibb.co/TTqdFXz/finish-1.webp" className="h-64 rounded-t-lg w-full object-cover sm:h-80 lg:h-96"
                        />
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="drywall_finish" src="https://i.ibb.co/CnjDDPk/finish-5.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="https://i.ibb.co/m5d7tkk/knockdowm.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="https://i.ibb.co/pXVQd1P/texure.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                        <h3 className="mt-4 text-lg font-bold text-gray-900 sm:text-xl">Texture </h3>
