...
export const Texture = () => {
    ...
    <section className="h-[1760px] sm:h-[1240px] lg:h-[860px] mb-20 overflow-hidden bg-[url(https://i.ibb.co/hg5Hvb0/machine.jpg)] bg-cover bg-center bg-no-repeat">
            ...
            <div className="text-center ltr:sm:text-left rtl:sm:text-right">
                ...
                <div className="p-4 mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4 ">
                    <div className="block bg-white/[.85] rounded-lg shadow-xl text-center">
                        <img alt="drywall" src="https://i.ibb.co/6v15zMm/finish-1-1.webp" className="h-64 rounded-t-lg w-full object-cover sm:h-80 lg:h-96"
                        />
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="drywall_finish" src="https://i.ibb.co/BB3w6c8/finish-5-1.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="https://i.ibb.co/gvqM4f7/knockdowm-1.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="https://i.ibb.co/ysy4CXz/texure-1.webp" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                        <h3 className="mt-4 text-lg font-bold text-gray-900 sm:text-xl">Texture </h3>
