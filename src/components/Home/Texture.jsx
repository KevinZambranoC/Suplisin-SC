...
export const Texture = () => {
    ...
    <section className="h-[1760px] sm:h-[1240px] lg:h-[860px] mb-56 overflow-hidden bg-[url(/machine.jpg)] bg-cover bg-center bg-no-repeat">
            ...
            <div className="text-center ltr:sm:text-left rtl:sm:text-right">
                ...
                <div className="p-4 mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-4 ">
                    <div className="block bg-white/[.85] rounded-lg shadow-xl text-center">
                        <img alt="drywall" src="/drywall.jpg" className="h-64 rounded-t-lg w-full object-cover sm:h-80 lg:h-96"
                        />
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="drywall_finish" src="/finish.jpg" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="/texture.jpg" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                    ...
                    <div className="block bg-white/[.85] rounded-lg shadow-xl">
                        <img alt="texture" src="/knockdown.jpg" className="h-64 w-full rounded-t-lg  object-cover sm:h-80 lg:h-96"/>
                        <h3 className="mt-4 text-lg font-bold text-gray-900 sm:text-xl">Texture </h3>
