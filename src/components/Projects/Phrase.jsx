...
export const Phrase = () => {
    return (
        <div className='relative h-[460px] md:h-[360px]'>
            <div className="bg-cover bg-center brightness-50 h-full object-fill bg-[url(https://images.unsplash.com/photo-1607400201515-c2c41c07d307?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)]">
            </div>
